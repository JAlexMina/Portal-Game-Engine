    ...
    m_graphics(nullptr)
{
    ...
    setMouseTracking(true);       // <------Set This to false for 2D UI Screen
    ...
    if(m_captureMouse) {
        ...
        QApplication::setOverrideCursor(Qt::ArrowCursor); // <------Use this for 2D UI Screen
    }
...
void View::initializeGL()
{
    ...
    m_app.setup(m_graphics, &m_captureMouse);
...
//    m_graphics->drawLine2D(glm::vec2(0, 0), glm::vec2(40, 0), 30);
...
void View::mouseMoveEvent(QMouseEvent *event)
{
    ...
    //m_camera->rotate(-deltaX / 1000.f, -deltaY / 1000.f);
